...
<div class="modal-content">
    <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">
            {{ $idElement == 0 ? 'Crer la configuration du distributeur '.$element->nom : 'Modifier la configuration du distributeur '.$element->nom }}</h5>
    ...
    <div class="modal-body">
        <div class="d-flex row m-3">
            <label for="nomDistrib"> nom du distributeur</label>
                ...
                value="{{ $element->nom }}" name="nomDistrib" id="nomDistrib" />
                ...
                <input type="text" class="form-control col-12" wire:model="mailDistrib" value=" {{ old('mail') ?? $element->mail }}" name="mailDistrib" 
                id="mailDistrib" />
                @error('mailDistrib')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
